...
> This section covers how skew is computed. For how skew maps to spline position, see [Liquidity Shaping §5](1.1.2.%20Liquidity%20Shaping.md#5-inventory-skew-mapping-skew--depth).
...
3. **Cooperative arbitrage** (proposed, see [Toxic Flow Mitigation §3.6](1.1.6.%20Toxic%20Flow%20Mitigation.md#36-cooperative-arbitrage) - 🚧 FUTURE WORK) would help restore equilibrium faster when coverage slips via rebates that would reward early rebalancing
...
2. **Flow Guard** (see [Flow Guards §Layer 2](../../3.%20Security/3.4.%20Flow%20Guards.md#layer-2-flow-guard-block-level-mev-protection)) enforces cooldowns on deposit→withdraw and stake→unstake operations, requiring multi-block coordination that makes JIT liquidity provisioning impractical
...
- [Liquidity Shaping](1.1.2.%20Liquidity%20Shaping.md), Spline-based depth curves
- [Spread & Fees](1.1.4.%20Spread%20&%20Fees.md), Fee calculation using coverage
- [Toxic Flow Mitigation](1.1.6.%20Toxic%20Flow%20Mitigation.md), Protection mechanisms
- [Internal Oracle](../1.2.%20Modules/1.2.2.%20Internal%20Oracle.md), Price feeds for coverage valuation
- [Parametrization](1.1.7.%20Parametrization.md), Full parameter reference
