---
title: "SDK Reference"
description: "Pointer to the @btr-protocol/sdk TypeScript package."
audience: both
type: reference
status: planned
phase: 1
...
```bash
npm install @btr-protocol/sdk
# or
bun add @btr-protocol/sdk
```

## Usage

Detailed API docs forthcoming. For now, see the package README for a quick-start example.
