---
title: "BTR TERMS OF SERVICE"
description: "## ⚠️ IMPORTANT NOTICE: GEOGRAPHIC RESTRICTIONS"
audience: both
type: reference
status: live
phase: n/a
...
These terms of service (the "Terms") govern your ("you" or "your") use of the services provided by BTR ("BTR", "the DAO", "we", "us" or "our"), including the web interface at [https://btr.supply](https://btr.supply) (the "Interface") and the Services (as defined below), and create a binding contract between you and us.

**Services** means, in respect of any User and as of any given time:
(a) the **BTR Supply (ALM) protocol** smart contracts, the BTR Swap aggregator, the Bridge, AccessControl, Treasury, Distributor, Staking, and Governance contracts (collectively, the "Phase-1 Services"); and
(b) if and only if the User has separately accepted the AIMM Acknowledgement (see [Acknowledgement (AIMM Phase-2)](./acknowledgement-aimm-phase2.md)), the **BTR DEX (AIMM)** protocol smart contracts (the "Phase-2 Services").

Phase-1 Services and Phase-2 Services are collectively the "Services". A User accepting these Terms without separately accepting the AIMM Acknowledgement is bound only to Phase-1 Services.
...
**Phase 1 Scope:** these Terms apply to BTR Supply (the ALM product). References to the BTR DEX (AIMM) describe a forward-looking product not currently deployed; AIMM-specific terms in §20 are conditional on AIMM mainnet launch and require separate acknowledgement.
...
**Non-exhaustive tax risks (illustrative, not advice):**

- **Staking-reward characterization**: US IRS Rev. Rul. 2023-14 treats staking rewards as gross income at fair market value upon dominion and control.
- **Impermanent-loss realization**: §1001 realization treatment of IL on concentrated-liquidity positions remains open under US tax authority.
- **Emission-token cost basis**: Cost basis allocation between emission tokens and underlying positions is jurisdiction-specific and unsettled.
- **Withdraw-event characterization**: A vault redemption may constitute a §1001 disposition (US) or CGT event (UK/EU) depending on share-token treatment.
- **FATCA/CRS account-closure**: Wind-down or forced exit may trigger account-closure reporting where the Foundation maintains reportable accounts.
...
### 15.bis. User Termination

User has the right at any time, subject to on-chain mechanics, to redeem their share tokens, withdraw their position, and cease interaction with the Services. BTR imposes no contractual penalty on User termination. On-chain mechanics (e.g., async redeem cooldown, withdraw delay during high-coverage events) are protocol features, not contractual termination penalties.
...
Disputes arising out of or relating to these Terms shall be finally resolved by arbitration administered by the **Hong Kong International Arbitration Centre (HKIAC)** under the HKIAC Administered Arbitration Rules in force when the Notice of Arbitration is submitted. **The seat of arbitration shall be the Cayman Islands.** The language shall be English. **EU and UK consumers retain non-waivable consumer-rights claims under their local consumer-protection law.** California, Quebec, and other jurisdictions with non-waivable class-action rights are not bound by the class-action waiver to the extent those rights are non-waivable in their jurisdiction.
